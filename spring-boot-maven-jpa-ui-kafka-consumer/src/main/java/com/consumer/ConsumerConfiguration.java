...
public class ConsumerConfiguration {
	...
	public ConsumerFactory<String, Device> consumerFactory() {
		...
		return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(Device.class));
	}
	...
	@Bean
	public DeviceConsumer consumer(){
		return new DeviceConsumer();
	}
